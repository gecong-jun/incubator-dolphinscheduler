...
export default {
   ...
   * @param "disable": boolen
   */
  createRole ({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.post('role/addRole', payload, res => {
        resolve(res)
      }).catch(e => {
        reject(e)
      })
   ...
   * @param "pageSize":int
   */
  getRoleListP ({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.get('role/list-paging', payload, res => {
        resolve(res.data)
      }).catch(e => {
        reject(e)
      })
  ...
  updateRole ({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.post('role/update', payload, res => {
        resolve(res)
      }).catch(e => {
        reject(e)
      })
  ...
  deleteRole ({ state }, payload) {
    return new Promise((resolve, reject) => {
      io.post('role/delete', payload, res => {
        resolve(res)
      }).catch(e => {
        reject(e)
      })
